        ...
        <div class="content">
          ...
          <div class="widget-wrap">
            ...
            <WidgetKPI
              ...
              ><template #title
                ><warning-alt-filled-icon fill="yellow" />Planned utilisation too low</template
              ><template #primary>&lt;15%</template>
              <template #body>
                Utilisation in upcoming month, complete annual plan and dispatch upcoming task to
                your technicians
              </template>
              <template #bottomline>View Utilisation<Arrow-right-icon /></template
            ></WidgetKPI>
            <!-- </RouterLink> -->
            <!-- </cv-column>
            <cv-column> -->
            <WidgetKPI
              ...
              @click="gotoPlanningMode()"
              ><template #title><circle-dash-icon />Maintenance plan 2026 available</template
          ...
          <div class="frame0">
            ...
            <div class="frame1">
              <div class="frame-content background_white">
                <div class="title0">
                  <div class="inline">
                    <in-progress-icon />&nbsp;Utilization Forecast: Required vs. Available Capacity
                  </div>
                </div>
                <cv-content-switcher
                  id="timeFrame"
            ...
            <div class="frame-content">
              ...
              <div>
                ...
                >
                  ...
                  <template #body>
                    Create your annual plan for 2026. 1647<br />Work Orders are available for annual
                    planning.
                  </template>
                </WidgetKPI>
              </div>
