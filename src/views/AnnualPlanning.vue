    ...
    <cv-row>
      <cv-column :lg="14">
        ...
        <div class="content">
          ...
          <!-- <cv-tile class="gradient" kind="expandable" :ai-label:size="mini"
            ><div>
              Welcome to your annual planning. What can you do on this page?
            </div>
            <template #below
              ><h1>More Content</h1>
              <p>Expanded000</p></template
            ></cv-tile
          > -->
          <div class="gradient">
            <div class="inline">
            ...
            <br />
            <br />
            <div class="widget-wrap w90 h-stretch">
              <div>
                <div class="bold pad16">Set your planning parameters</div>
                <div class="pad16">
                  The planning parameters determine how the system calculates your plan. The
                  standard parameters for annual planning are “Resource allocation” to spread work
                  evenly across the year, “Max. Utilisation 80%” to limit the technicians
                  utilisations and “Optimise Routes” to bundle work orders who are in the same
                  location.
                </div>
              </div>
              <div>
                <div class="bold pad16">Select affected work orders</div>
                <div class="pad16">
                  Choose which work orders to include in your plan. E.g. if you want to only plan
                  “Inspection type XY” you can filter down the selected work orders accordingly.
                </div>
              </div>
              <div>
                <div class="bold pad16">Set time frame and region</div>
                <div class="pad16">
                  Select the time frame (annual planning is always 1 year) and the affected region
                  you want to plan. You can select multiple regions at the same time if you are
                  permitted to do so.
                </div>
              </div>
            </div>
          ...
          <div class="widget-wrap">
            ...
            <WidgetKPI>
              ...
              <template #primary> Annual </template>
              <template #body>
            ...
            <WidgetKPI
              ...
              ><template #primary>01.01.- 31.12.2026</template
              ><template #bottomline>Edit<edit-icon /></template
            ></WidgetKPI>
            <!-- </cv-column>
            <cv-column> -->
            <WidgetKPI
              ><template #title><circle-dash-icon />Work Orders</template
              ><template #primary>1647</template><template #body>unplanned work orders</template
              ><template #bottomline>Edit<edit-icon /></template
            ></WidgetKPI>
            <!-- </cv-column>
            <cv-column> -->
            ...
            <WidgetKPI
              ...
              ><template #primary>4 FTE</template
              ><template #body>880 PD/year<br />(incl. vacation, sickness, training)</template
              ><template #bottomline>Edit<edit-icon /></template
            ></WidgetKPI>
            <!-- </cv-column> -->
          </div>
          <div class="frame0">
            <div class="frame1">
              ...
              <div class="frame-content background_white">
                <FrameTitle>
                  <template #title> External providers (21)</template>
            ...
            <div class="frame1">
              <div class="frame-content background_white">
                ...
                <div class="pad16 map">
                  ...
                  <cv-tag class="mapTag1" label="847" kind="high-contrast" />
                  <cv-tag class="mapTag2" label="150" kind="high-contrast" />
                  <cv-tag class="mapTag3" label="500" kind="high-contrast" />
                </div>
                <div
              ...
              <div class="frame-content background_white">
                <FrameTitle>
                  <template #title> Estimated required qualifications (206)</template>
                  <template #subtitle
                    ><div class="subtitle">
                      Shown qualifications are estimated to fulfill all selected work orders.
                    </div></template
                  >
                  <template #rightSide>
                    <cv-button class="button_ghost" :icon="NewTabIcon" kind="ghost">
            ...
            <div class="bottom">
              <div class="guidance">
                ...
                <cv-list nested class="outdent guidance-content">
                  ...
                  <cv-list-item>
                    <span class="guidance-content bold">Work Orders:</span>
                    Select the work orders to be scheduled.
                  </cv-list-item>
                  <cv-list-item>
