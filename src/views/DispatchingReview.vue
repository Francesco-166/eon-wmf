...
import {
  ...
  TableOfContents16 as TableOfContentsIcon,
  DistributeVerticalTop16 as DistributeVerticalTopIcon,
          ...
          <div>
            ...
            >
              ...
              <template #data>
                ...
                >
                  <cv-data-table-cell
                    ><div class="link">{{ wo.name }}</div></cv-data-table-cell
                  >
                  <cv-data-table-cell>{{ wo.id }}</cv-data-table-cell>
                  <cv-data-table-cell
                    ><cv-tag
                      :render-icon="CertificateCheckIcon"
                      :label="wo.status.title"
                      :kind="wo.status.color"
                  /></cv-data-table-cell>
                  <cv-data-table-cell
                    ><cv-tag
                      :render-icon="ArrowRightIcon"
                      :label="`${wo.priority.title} (${wo.priority.score})`"
                  ...
                  <cv-data-table-cell>
                    <cv-tag
                      ...
                      :label="`+${wo.quals.length}`"
                      kind="high-contrast"
                    />
                    <cv-tag v-else :label="wo.quals[0]" kind="high-contrast" />
                  </cv-data-table-cell>
                  <cv-data-table-cell>
                    <div class="inline">
                    ...
                    >
                      ...
                      <template #data>
                        ...
                        >
                          ...
                          <cv-data-table-cell
                            ><cv-tag :label="o.equip" kind="green"
                          /></cv-data-table-cell>
                          <cv-data-table-cell>
                            <cv-tag
                              v-if="o.quals.length > 1"
                          ...
                          <cv-data-table-cell>
                            <div class="inline">
                              ...
                              <div v-if="o.assigned.length > 1" class="inline">
                                <group-icon />&nbsp;
                                <cv-tag
                                  :label="`${o.assigned.length} technicians`"
                                  kind="high-contrast"
                                />
                              </div>
                              <div v-else class="inline">
