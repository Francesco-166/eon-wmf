      ...
      <cv-column :lg="13">
        ...
        <div class="content">
          ...
          <div class="widget-wrap">
            ...
            <WidgetKPI
              ><template #title
                ><information-square-filled-icon fill="blue" />Work Orders ready for dispatching</template
            ...
            ></WidgetKPI>
            <WidgetKPI @click="gotoDispatchingGanttPlanner()"
              ><template #title
                ><checkmark-filled-icon fill="green"/>Est. utilisation upcoming month</template
              ><template #primary>81%</template
              ><template #body
                >utilisation of technicians<br /> </template
              ><template #bottomline
                >Open planner (Gantt chart)<Arrow-right-icon /></template
            ></WidgetKPI>
          </div>
          <div class="frame0">
            <div class="frame1">
          ...
          <div class="right-content">
            <div class="frame-content">
              ...
              <div v-if="showNotification" class="popup green border-left border-green" @click="hideNotification()">
                  ...
                  <div class="popup-middle"><div class="bold">Success: January dispatched</div><br/>You have successfully dispatched 130 work orders for the upcoming month.<br /><br /><br />01.01.2026 - 08:45 Uhr</div>
